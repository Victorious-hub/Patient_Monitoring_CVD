...
urlpatterns = [
    ...
    path('v1/patient/blood/analysis/<str:slug>', PatientBloodCreateApi.as_view(), name='patient_blood_analysis'),
    path('v1/patient/blood/analysis', PatientBloodListeApi.as_view(), name='list_blood_analysis'),
